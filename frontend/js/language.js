...
const LanguageModule = {
  ...
  translations: {
    ...
    mr: {
      ...
      validation: { invalidEmail: 'कृपया योग्य ईमेल पत्ता लिहा.', weakPassword: 'पासवर्ड किमान 6 अक्षरांचा असावा.', missingEmail: 'कृपया तुमचा ईमेल पत्ता लिहा.', nameRequired: 'कृपया तुमचे पूर्ण नाव लिहा.', wrongPassword: 'ईमेल किंवा पासवर्ड चुकीचा आहे.', emailInUse: 'हा ईमेल आधीपासून नोंदणीकृत आहे.', network: 'कनेक्ट करता आले नाही. इंटरनेट कनेक्शन तपासा.', default: 'काहीतरी चुकले. पुन्हा प्रयत्न करा.', resetUnavailable: 'पासवर्ड बदलण्याचा ईमेल पाठवता आला नाही.' },
    ...
    hi: {
      ...
      validation: { invalidEmail: 'कृपया सही ईमेल पता लिखें।', weakPassword: 'पासवर्ड कम से कम 6 अक्षरों का होना चाहिए।', missingEmail: 'कृपया अपना ईमेल पता लिखें।', nameRequired: 'कृपया अपना पूरा नाम लिखें।', wrongPassword: 'ईमेल या पासवर्ड गलत है।', emailInUse: 'यह ईमेल पहले से पंजीकृत है।', network: 'कनेक्ट नहीं हो सका। इंटरनेट कनेक्शन जांचें।', default: 'कुछ गलत हो गया। फिर से प्रयास करें।', resetUnavailable: 'पासवर्ड रीसेट ईमेल नहीं भेजा जा सका।' },
    ...
    te: {
      ...
      validation: { invalidEmail: 'సరైన ఈమెయిల్‌ను నమోదు చేయండి.', weakPassword: 'పాస్‌వర్డ్ కనీసం 6 అక్షరాలు ఉండాలి.', missingEmail: 'ఈమెయిల్ నమోదు చేయండి.', nameRequired: 'దయచేసి పూర్తి పేరు నమోదు చేయండి.', wrongPassword: 'ఈమెయిల్ లేదా పాస్‌వర్డ్ తప్పు.', emailInUse: 'ఈమెయిల్ ఇప్పటికే నమోదు చేయబడింది.', network: 'కనెక్ట్ కాలేకపోయాము.', default: 'ఏదో తప్పు జరిగింది.', resetUnavailable: 'ఈమెయిల్ పంపలేకపోయాము.' },
